...
export type ClientMsg =
  ...
  | { op: 'pty_attach'; project: string; cmd: 'claude' | 'shell'; cols: number; rows: number; launch?: PtyLaunch; fresh?: boolean; os?: 'windows' } // riusa o crea; con launch: kill+respawn coi flag; fresh: kill+respawn pulito; os:'windows' = claude/shell su Windows nativo (ponte ConPTY)
