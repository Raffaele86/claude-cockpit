...
const IT = {
  ...
  inboxNote: 'Solo sessioni della vista chat: le schede CLI non riportano lo stato qui.',
...
const EN: typeof IT = {
  ...
  inboxNote: 'Chat-view sessions only: CLI tabs do not report their state here.',
