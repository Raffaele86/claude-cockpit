...
const IT = {
  ...
  autoCheckpointHint: 'Snapshot dei file del progetto prima di ogni prompt in vista chat (max uno ogni 10 minuti). Ripristino dal pannello 📸.',
...
const EN: typeof IT = {
  ...
  autoCheckpointHint: 'Snapshot the project files before every chat prompt (at most one every 10 minutes). Restore from the 📸 panel.',
